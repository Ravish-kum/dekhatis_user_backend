...
from .models import Product,Shop_table, Customer_table,Query_table,Images_table,Advertisement_table,Review_table, Cancellations_table,User, ThemeFurnituresBookings , ThemeFurniture,Dekhatis_Delivery_table,Wood_Servicing_table,Serving_CRM_table,User_CRM_table,Query_CRM_table
...
admin.site.register(Serving_CRM_table)
admin.site.register(Query_CRM_table)
admin.site.register(User_CRM_table)
